...
static void put_integer(void (*)(char),  unsigned long long, int, int, char, int);

void test_vprintf(void (*__putc)(char), const char *fmt, va_list ap)
{
...
static void put_integer(void (*__putc)(char), unsigned long long n, int radix, int length, char sign, int flags)
{
